...
INSERT INTO T_PRODUCT(id, store_fk, status, is_deleted, title, summary, description, price, comparable_price, currency, quantity, published, deleted, type)
    VALUES
        (100, 1, 2, false, 'TV', 'summary of TV', 'description of TV', 150000, 200000, 'XAF', 10, now(), null, 1)
    ;
