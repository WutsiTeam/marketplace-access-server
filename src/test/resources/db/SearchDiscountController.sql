...
INSERT INTO T_DISCOUNT(id, store_fk, name, rate, starts, ends, all_products, is_deleted, deleted)
    VALUES
        ...
        (101, 1, 'FIN25', 25, '2020-01-05', '2020-01-07', true, false, null),
        (102, 1, 'FIN25', 25, '2021-01-05', '2021-01-07', true, false, null),
        (110, 1, 'FIN50', 25, '2022-01-01', '2022-02-01', false, false, null),
        (199, 1, 'FIN99', 99, '2020-01-01', '2020-01-30', true, true, now()),
        (200, 2, 'FIN10', 10, '2020-01-01', '2020-01-30', true, false, null)
    ;
